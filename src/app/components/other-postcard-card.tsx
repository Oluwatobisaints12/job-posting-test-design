...
export default function OtherCard({ category }: { category: { category_type: string; image_url: string } }) {
    return (
        <div className="bg-[#F4F4F4] rounded-[5px] w-[265px] h-[367px] px-[21px] py-[22px] border-b-4 border-b-[#D5D3D3] shadow-[0_4px_10px_-1px_rgba(0,0,0,0.2)] overflow-hidden">
            <div className="relative w-full h-[234px]">
                <Image
                    ...
                    alt={category.category_type || "category name"}
                    fill
            ...
            <div className="mt-[1rem]">
                <h3 className={`text-[#282828] text-[1.125rem] ${montserratBold.className}`}>{category.category_type}</h3>
